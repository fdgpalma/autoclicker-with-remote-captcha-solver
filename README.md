...
Integrates remote CAPTCHA solver via Flask API (Python + pytesseract/OCR), Android app (Kotlin), and pyautogui/Selenium for browser. Features Weibull/Gamma pauses for distractions and routine sleep (±15min/day). Ethical for automation/testing; MIT license.
